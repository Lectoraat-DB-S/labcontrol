...
1. Download install.bat: volg deze [link](https://github.com/Lectoraat-DB-S/labcontrol/blob/main/labcontrol/installer/batch/install.bat). Klik daarna op 'Download raw file'. In dezelfde map bevindt zich een handleiding, bedoeld voor diegene die graag vooraf wil weten welke acties de installer doet en welke software nu gedownload en geïnstalleerd gaat worden.
