...
1. Download install.bat: volg deze [link](https://github.com/Lectoraat-DB-S/labcontrol/blob/main/src/installer/batch/install.bat). Klik daarna op 'Download raw file'. In dezelfde map is ook een Word handleiding te vinden.
