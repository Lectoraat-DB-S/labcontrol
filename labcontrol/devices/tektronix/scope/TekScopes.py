...
class TekScope(Scope):
    ...
    def getScopeClass(cls, rm, urls, nrOfChan=None, host=None, scopeConfig: BaseScopeConfig = None):
        ...
        2.  returns either the class of a Tektronix TDS 2kC series oscilloscope and the corresponding VISA object, if the url or idn response matches, or 
    ...
    #def __init__(self, visaResc: pyvisa.resources.MessageBasedResource):
        ...
        self.vertical = TekVertical(2, visaInstr, self.nrOfHoriDivs, self.nrOfVertDivs, self.visibleHoriDivs, self.visibleVertDivs)
