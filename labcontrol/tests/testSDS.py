...
import tests.sdsUtils as sdsUtils
import numpy as np
import matplotlib.pyplot as plt
from devices.siglent.sds.SDS1000.Channel import SDSWaveFormPreamble
...
class TestSDSCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.scope:Scope = Scope.getDevice()
    ...
    def testCaptureSDS(self):
        ...
        verticaal: Vertical = self.scope.vertical
        
        thechan: Channel = verticaal.chan(1)
        thechan.capture()
        trace = thechan.WF
        y = trace.rawYdata
        x = trace.rawXdata
